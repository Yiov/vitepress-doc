...
<template>
    ...
    <div v-if="visible" class="notice">
        ...
        <div class="notice-describe">
            ...
            <p>QQ 频道：乔先森的知识库</p>
            <img class="notice-img" src="https://image.qxiansen.online/d/%E5%A4%A9%E7%BF%BC%E4%BA%91%E7%9B%98/images/docs/qrcode.png?sign=Zx2eHsF7plr83aeSe9kIS-gygVTwkmNKQ9_ZoYKeS9g=:0">
        </div>
